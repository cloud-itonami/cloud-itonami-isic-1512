# Business Model: Luggage, Handbag & Saddlery/Harness Manufacturing
...
## Classification
- Repository: `cloud-itonami-isic-1512` ([github.com/cloud-itonami/cloud-itonami-isic-1512](https://github.com/cloud-itonami/cloud-itonami-isic-1512))
- ISIC Rev.5: `1512` — Luggage, Handbag & Saddlery/Harness Manufacturing
- Domain: `:luggage/manufacturing`
- Social impact: :fair-labor :local-industry :material-sourcing-transparency
- Actor: `:luggage-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :luggage/manufacturing — who wants
...
One managed tenant (:luggage/manufacturing):
...
- Do not bypass the `:luggage-governor` for production decisions.
